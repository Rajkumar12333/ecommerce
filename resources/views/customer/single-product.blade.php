      ...
      <div class="row row-sm">
         <div class="col-md-6 _boxzoom">
            <div class="zoom-thumb">
               <ul class="piclist">
                  <li><img src="{{asset($products->image)}}" alt=""></li>
            ...
            <div class="_product-images">
               <div class="picZoomer">
                  <img class="my_img" src="{{asset($products->image)}}" alt="">
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="_product-detail-content">
               <p class="_p-name"> {{$products->product}} </p>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-md-12 list-slider mt-4">
            ...
            @foreach($lastFourRecords as $page)
               <div class="item">
                  <div class="sq_box shadow">
                     ...
                     <h4 class="mb-1"> <a href="details.php"> {{$page->product}} </a> </h4>
                     <div class="price-box mb-2">
                        <span class="price"> Price <i class="fa fa-inr"></i> 200 </span>
                        <span class="offer-price"> Offer Price <i class="fa fa-inr"></i> {{$page->price}} </span>
                     </div>
